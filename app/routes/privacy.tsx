...
export default function PrivacyPolicy() {
  return (
    <div style={{ maxWidth: 800, margin: "0 auto", padding: "2rem", fontFamily: "system-ui, sans-serif", lineHeight: 1.6 }}>
      ...
      <h2>9. Contact</h2>
      <p>
        If you have questions about this Privacy Policy, please contact us through the support feature within the Import Pilot app, or email us at support@importpilot.app.
      </p>
    </div>
  );
}
