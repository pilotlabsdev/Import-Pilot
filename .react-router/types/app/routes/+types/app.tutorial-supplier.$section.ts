...
type Module = typeof import("../app.tutorial-supplier.$section.js")

type Info = GetInfo<{
  file: "routes/app.tutorial-supplier.$section.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.tutorial-supplier.$section.js");
}];
