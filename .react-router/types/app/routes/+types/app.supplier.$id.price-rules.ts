...
type Module = typeof import("../app.supplier.$id.price-rules.js")

type Info = GetInfo<{
  file: "routes/app.supplier.$id.price-rules.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../app.supplier.$id.price-rules.js");
}];
